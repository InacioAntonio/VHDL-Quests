...
-- parity	=>  Location: PIN_AE23,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
ARCHITECTURE structure OF Questao4ListaVhdl IS
...
-- Equation(s):
-- \parity~0_combout\ = \B~combout\ $ (\A~combout\ $ (\C~combout\))
